...
> **URL PUBBLICO**: [https://maroon-giraffe-522842.hostingersite.com/](https://maroon-giraffe-522842.hostingersite.com/)  
...
| Nome | Ruolo | Email di Accesso | Password Iniziale | Note |
|---|---|---|---|---|
| **Erika** | `admin` | `erika@solarbrand.it` | `SolarBrand2026!` | 👑 **Super Admin**: Gestione team, reset password, campagne email |
...
La cartella PRIMARIA su Google Drive E' QUELLA GIUSTA collegata a GitHub per il deploy continuo su Hostinger.
